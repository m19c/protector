    ...
    createBranchProtectionRule(repository, pattern, _a) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.client.mutate({
                ...
                variables: {
                    input: Object.assign(Object.assign({ pattern, repositoryId: repository.id }, rule), { pushActorIds: pushActors.length > 0
                            ? yield this.resolveActors(this.getOrganizationHandle(repository), pushActors)
                            : undefined, reviewDismissalActorIds: reviewDismissalActors.length > 0
